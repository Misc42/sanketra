...
const values = [
  ...
  ["The Hindi+English combo engine, optional", "Opt in under Settings → STT Engine for sharper, faster transcription. Hindi routes to IndicConformer, English to Parakeet — cleaner Hindi, properly punctuated English, 10–20× real-time on CPU. Whisper stays the default."],
